...
public class AppMain12 extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        // ------------------------
//        Parent root = FXMLLoader.<GridPane>load(
//            Objects.requireNonNull(
//                this.getClass().getResource("AppMain12.fxml"),
//                "No AppMain12.fxml found."
//            )
//        );  // .load
//
//        log.info("\t+ root: {}", root);
        ...
        // ------------------------
        FXMLLoader loader = new FXMLLoader(this.getClass().getResource("AppMain12.fxml"));
        Parent root = loader.<GridPane>load();
        ...
        // ------------------------
        primaryStage.setTitle("AppMain12");
