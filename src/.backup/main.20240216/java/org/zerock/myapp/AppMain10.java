...
public class AppMain10 extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        // ------------------------
//        Parent root = FXMLLoader.<FlowPane>load(this.getClass().getResource("AppMain10.fxml"));
//        log.trace("\t+ root: {}", root);

        // ------------------------
        FXMLLoader loader = new FXMLLoader(this.getClass().getResource("AppMain10.fxml"));

        Parent root = loader.<FlowPane>load();
        log.trace("\t+ root: {}", root);
        ...
        children.forEach(button -> {
            button.setOnMouseClicked(e -> log.trace("{}::setOnMouseClicked({}) invoked.", button, e)); // .setOnMouseClicked
        }); // .forEach

        // ------------------------
        primaryStage.setTitle("AppMain10");
