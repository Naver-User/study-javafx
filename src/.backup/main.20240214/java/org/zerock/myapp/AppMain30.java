    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        Parent root = FXMLLoader.load(
            Objects.requireNonNull(
                this.getClass().getResource("AppMain30.fxml"),
                "No AppMain30.fxml found."
            )
        );  // .load
        ...
        scene.getStylesheets().add(
            Objects.requireNonNull(
                this.getClass().getResource("/css/AppMain30.css"),
                "No /css/AppMain30.css found."
            ).toString()
        );  // .add

        // ------------------
        primaryStage.setTitle("AppMain30");
