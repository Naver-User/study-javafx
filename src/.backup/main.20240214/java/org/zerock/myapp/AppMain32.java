    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        Parent root = FXMLLoader.load(
            Objects.requireNonNull(
                this.getClass().getResource("AppMain32.fxml"),
                "No AppMain32.fxml found."
            )
        );  // .load
        ...
        scene.getStylesheets().add(
            Objects.requireNonNull(
                this.getClass().getResource("/css/AppMain32.css"),
                "No /css/AppMain32.css found."
            ).toString()
        );  // .add

        // ------------
        primaryStage.setTitle("AppMain32");
