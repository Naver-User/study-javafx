...
import org.zerock.myapp.controller.RootController23;
...
//                this.getClass().getResource("AppMain23.fxml"),
//                "No AppMain23.fxml found."
//            )
//        );  // .load
...
//        root.getChildrenUnmodifiable().forEach(log::info);
        ...
        // ------------
        FXMLLoader loader = new FXMLLoader(this.getClass().getResource("AppMain23.fxml"));
        log.info("1. loader: {}", loader);

        Parent root = loader.<AnchorPane>load();
        log.info("2. root: {}", root);

        RootController23 controller = loader.getController();
        log.info("3. controller: {}", controller);

        root.getChildrenUnmodifiable().forEach(log::info);

        // ------------
        primaryStage.setTitle("AppMain23");
