...
import org.zerock.myapp.controller.RootController22;
...
public class AppMain22 extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        // --------------
        FXMLLoader loader = new FXMLLoader(this.getClass().getResource("AppMain22.fxml"));
        ...
        RootController22 controller = loader.getController();
        log.info("controller: {}", controller);

        // --------------
        primaryStage.setTitle("AppMain22");
