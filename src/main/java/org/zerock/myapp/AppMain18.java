...
//                this.getClass().getResource("AppMain18.fxml"),
//                "No AppMain18.fxml found."
//            )
//        );  // .load
//        log.info("root: {}", root);
//
//        root.getChildrenUnmodifiable().forEach(log::info);
        ...
        // ---------------
        FXMLLoader loader = new FXMLLoader(this.getClass().getResource("AppMain18.fxml"));
        ...
        // ---------------
        primaryStage.setTitle("AppMain18");
