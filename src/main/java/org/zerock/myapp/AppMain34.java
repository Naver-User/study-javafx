    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        Parent root = FXMLLoader.load(
            Objects.requireNonNull(
                this.getClass().getResource("AppMain34.fxml"),
                "No AppMain34.fxml found."
            )
        );  // .load
        ...
        // Apply the specified CSS file to the specified whole scene.
        scene.getStylesheets().add(
            Objects.requireNonNull(
                this.getClass().getResource("/css/AppMain34.css"),
                "No /css/AppMain34.css found."
            ).toString()
        );  // .add

        // -------------
        primaryStage.setTitle("AppMain34");
